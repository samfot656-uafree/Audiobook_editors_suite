...
#-----create_project_structure-----
    ...
    def create_project_structure(project_name: str, input_text_path: str = None, 
        ...
        folders = [
            ...
            f"{project_path}/temp_folder/temp_multispeakers",
...
#-----_create_project_config-----    
    ...
    def _create_project_config(project_path: str, project_name: str) -> Dict[str, Any]:
        ...
        config = {
            ...
            "SOUND_EFFECTS_EDITOR_INPUT_SOUNDS_EFFECTS_FOLDER": f"{base_path}/inputs/input_sounds_effects",
  ...
  #zd==========
            "MULTISPEAKER_TTS_INPUT_MELODY_FOLDER": f"{base_path}/inputs/input_melodu",
            "MULTISPEAKER_TTS_INPUT_SOUNDS_EFFECTS_FOLDER": f"{base_path}/inputs/input_sounds_effects",
            "MULTISPEAKER_TTS_OUTPUTS_FOLDER": f"{base_path}/outputs/output_multispeakers",
            "MULTISPEAKER_TTS_TEMP_FOLDER": f"{base_path}/temp_folder/temp_multispeakers",
