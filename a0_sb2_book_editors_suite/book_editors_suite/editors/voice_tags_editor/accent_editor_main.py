...
# Не варто додавати наголоси в кожне слово. Лише до проблемних для певної TTS: вигадані назви, сленг, специфічні терміни, омоніми. Замінити прослуховування з андроїд ттс на потрібну.
...
class AccentEditorApp(App):
    ...
    def save_full_mp3(self):
        ...
        try:
            ...
            self.base_editor.logger.info(f"MP3 збережено: \n{out_f_path}")
